...
lazy_static::lazy_static! {
    ...
    pub static ref PUBLIC_KEY: RwLock<String> =
        RwLock::new("BAEeXn058vN+H4UFLjIQ25cOibJj21Av36d1SmUiols=".to_owned());
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> =
        RwLock::new("rustdesk.coimbraits.hu".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> =
        RwLock::new("rustdesk.coimbraits.hu".to_owned());
    pub static ref APP_NAME: RwLock<String> = RwLock::new("CRS".to_owned());
